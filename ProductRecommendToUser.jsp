...
<html lang="en">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#" class="nav-link">View Product Recommendation</a></li>
  ...
  String query="select * from productrecommend";
  PreparedStatement ps=con.prepareStatement(query);
  ResultSet rs=ps.executeQuery();
  while(rs.next())
  {
	 Integer ProduuctId=rs.getInt(2);
	 String ProductName=rs.getString(3);
	 map.put(ProduuctId, ProductName);
 ...
 String query1="select * from productrecommend";
 ...
 Set<String> unique = new HashSet<String>(product);
	for (String key : unique) {
	    ...
	    filter.put(key, Collections.frequency(product, key));
	}
	System.out.println(filter);
	
	  /* int maxValueInMap=(Collections.max(filter.values()));  
      for (java.util.Map.Entry<String, Integer> entry : filter.entrySet()) {  
          if (entry.getValue()==maxValueInMap) {
              System.out.println("Product recommend"+entry.getKey());     
  ...
  %>
    ...
    <tr>
      ...
      <th scope="row">Recommendation of Product is=<%=entry.getKey() %></th>
